  ...
  return <div className='profile'>
    ...
    <main>
      <form onSubmit={onSubmit}>
        ...
        <input type="text" className="formInputName" value={name} id="name" onChange={onMutate} maxLength="32" minLength="10" required />

        <div className="formRooms flex">
          <div>
            <label className="formLabel">Bedrooms</label>
            <input type="number" className="formInputSmall" id="bedrooms" onChange={onMutate} value={bedrooms} min="1" max="50" required />
          </div>
          <div>
            <label className="formLabel">Bathrooms</label>
            <input type="number" className="formInputSmall" id="bathrooms" onChange={onMutate} min="1" max="50" value={bathrooms} required />
          </div>
        </div>
